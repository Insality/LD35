...
// Added Easing type ang get easing func by this type by Insality
...
public class Easing{
    ...
    // Return the easing function by EasingType
    public static Func<double, double, double, double, double> GetEasingByType(EasingType type)
    {
        switch (type)
        {
